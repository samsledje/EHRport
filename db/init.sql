...
INSERT INTO doctor (`_id`, firstname, lastname, email) VALUES
(1, "David", "Mills", "david.mills@uconn.edu"),
(2, "Laurent", "Michel", "laurent.michel@uconn.edu");

INSERT INTO room (`_id`, title, patient, activity, create_time) VALUES
(1, "Earache", 1, 0, CURRENT_TIMESTAMP),
(2, "Toothache", 1, 1, CURRENT_TIMESTAMP),
(3, "Footache", 2, 1, CURRENT_TIMESTAMP),
(4, "Headache", 2, 2, CURRENT_TIMESTAMP);
...
INSERT INTO event_ (`_id`, doctor, room, contents, create_time) VALUES
(1, 1, 1, "Patient complaining of ear pain", CURRENT_TIMESTAMP),
(2, 1, 1, "Patient prescribed cocaine", CURRENT_TIMESTAMP),
(3, 2, 2, "Patient complaining of tooth pain", CURRENT_TIMESTAMP),
(4, 2, 2, "Patient has tooth surgery", CURRENT_TIMESTAMP),
(5, 1, 3, "Patient complaining of foot pain", CURRENT_TIMESTAMP),
(6, 1, 3, "Patient had foot amputated", CURRENT_TIMESTAMP),
(7, 2, 4, "Patient complaining of headaches", CURRENT_TIMESTAMP),
(8, 2, 4, "Patient prescribed cyproheptadine", CURRENT_TIMESTAMP);
